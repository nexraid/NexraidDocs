...
## Exceptions
Exceptions to corporate policies can only occur with explicit approval from the [Information Security Steering Committee (ISSC)](Information-Security-Steering-Committee.md). An Exception Policy exists for the processing, approval and maintenance of such instances.
