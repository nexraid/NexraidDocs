...
```
Inline-style: 
![alt text](../images/customer-logo/NEXRAID_LOGO_final_Logo_Horizontal.png "Logo Title Text 1")

Reference-style: 
![alt text][logo]

[logo]: https://github.com/liulunghao/Feezmodo/blob/master/images/customer-logo/NEXRAID_LOGO_final_Logo_Horizontal.png "Logo Title Text 2"
```
