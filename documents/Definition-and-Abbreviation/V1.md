...
description: "This document states all the definition and abbreviation throughout NexRaid Documentation."
keywords: 
  - definition
  - abbreviation
  - guideline
...
## A
### Account Data
"Account Data" can be any of the following:
...
### Applicable Monthly Service Fees
...
"Applicable Yearly Period" means, for a calendar year in which a Service Credit is owed, the number of days that you are a subscriber for a Service.

### Applicable Yearly Service Fees
"Applicable Yearly Service Fees" means the total fees actually paid by you for a Service that are applied to the year in which a Service Credit is owed.
...
## B
### Business Hours
"Business Hours" is from 9:00AM to 5:00PM Singapore Time (SGT), Monday to Friday, excluding public holidays.

## C
### Captured Data
Same as [Generated Data](#GeneratedData).
...
### Confidential Data
Same as [Confidential Information](#Confidential-Information).
...
### Downtime
"Downtime" is the total accumulated minutes that are part of Maximum Available Minutes that have no Connectivity to our service.
...
## G
### Generated Data
"Generated Data" can be any of the following:
...
### Incident
"Incident" means
1. any single event, or
2. any set of events, that result in Downtime.
...
## M
### Management Portal
"Management Portal" means the web interface, provided by Nexraid, through which customers may manage the Service.

### Maximum Available Minutes
"Maximum Available Minutes" is the total accumulated minutes during a billing month, measured from when at the service has been paid and successfully activated to the time Customer has initiated an action that would result in stopping or deleting the resource or service, such as unpaid invoice.

### Monthly Uptime Percentage
"Monthly Uptime Percentage" is calculated as Maximum Available Minutes less Downtime divided by Maximum Available Minutes in a billing month for a given Nexraid Service. Monthly Uptime Percentage is represented by the following formula:
...
"Personally Identifiable Information" means any information relating to an identified or identifiable natural person ("Data Subject"). An identifiable natural person is one who can be identified, directly or indirectly, in particular by referencing an identifier such as a name, an identification number, location data, an online identifier, or to one or more factors specific to the physical, physiological, genetic, mental, economic, cultural, or social identity of that natural person.
...
### Service Credit
"Service Credit" is the percentage of the Applicable Monthly/Yearly Service Fees credited to you following Nexraid’s claim approval.

### Service Level
"Service Level" means the performance metric(s) set forth in the SLA that Nexraid agrees to meet in the delivery of the Services.
...
### Sensitive Data
"Sensitive Data" are any data that is:
...
* Immigration status (such as visa, work authorization etc)
* Government Identifiers (such as passport, driver’s license, visa, social security numbers, national identify numbers)
...
Singapore Standard Time is 8 hours ahead of Greenwich Mean Time (GMT+8) and there is no Daylight Saving Time (DST).

### Singapore Time (SGT)
Same as [Singapore Standard Time (SGT)](#Singapore-Standard-Time-SGT).
...
### Support Hours
Same as [Support Window](#Support-Window).
...
"Yearly Uptime Percentage" is calculated as Maximum Available Minutes less Downtime divided by Maximum Available Minutes in a billing year for a given Nexraid Service. Yearly Uptime Percentage is represented by the following formula:

` Yearly Uptime % = (Maximum Available Minutes – Downtime) / Maximum Available Minutes X 100 `
